        ...
        <div class="row">
          ...
          <div id="myModal2" class="modal fade" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Data Tahanan</h4>
                </div>
                <!-- body modal -->
                <div class="modal-body">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              ...
              <form action="<?php echo base_url(); ?>surat_penahanan/pdf" method="post" enctype="multipart/form-data" id="submit">
                <div class="box-body">
                  ...
                  <div class="box-body pad>
                    <label for="exampleInputEmail1"><b>Tahanan</b></label>
                  </div>
                  <div class="input-group box-body pad">
                    <input type="text" id="tahanan" name="tahanan" placeholder="Masukkan Penerima" class="form-control">
                    <span class="input-group-addon" style="background-color: #00c0ef"><a style="color: white;" data-toggle="modal" data-target="#myModal2">Tahanan</a></span>
                  </div>

                  <!-- <div class="box-body pad>
                    <label for="exampleInputEmail1"><b>Penanda Tangan</b></label>
                  </div>
                  <div class="input-group box-body pad">
                    <input type="text" id="penerima" name="penerima" placeholder="Masukkan Penerima" class="form-control">
                    <span class="input-group-addon" style="background-color: #00c0ef"><a style="color: white;" data-toggle="modal" data-target="#myModal">Penanda Tangan</a></span>
                  </div>
 -->
                ...
                <div class="box-footer">
                  ...
                  <button type="submit" id="submit" class="btn btn-primary pull-right">Cetak</button>
                </div>
              </form>
            </div>
          </div>
