        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              ...
              <form action="<?php echo base_url(); ?>users/update" method="post" enctype="multipart/form-data" id="submit">
                <div class="box-body">
                  <div class="box-body pad">
                    <label for=" exampleInputEmail1"><b>Nama Lengkap</b></label>
                    <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="Masukkan Nama Lengkap" value="<?= $users->nama ?>" required>
                    <input type="hidden" class="form-control" id="id_user" name="id_user" placeholder="Masukkan Nama Lengkap" value="<?= $users->id_user ?>" required>
                  </div>

                  <div class="box-body pad">
                    <label for=" exampleInputEmail1"><b>Jabatan</b></label>
                    <input type="text" class="form-control" id="nama_lengkap" name="jabatan" placeholder="Masukkan Jabatan" value="<?= $users->jabatan ?>" required>
                  </div>

                  <div class="box-body pad">
                    <label for=" exampleInputEmail1"><b>NIP</b></label>
                    <input type="text" class="form-control" id="nip" name="nip" placeholder="Masukkan NIP" value="<?= $users->nip ?>"  required>
                  </div>

                    <?php foreach($instansi as $r) 
                    {
                      if($r->id==$users->instansi){
                        $a = $r->nama;
                      } 
                    } ?> 
                  ...
                  <?php if ($this->role == 1) { ?>
                    ...
                    <div class="input-group box-body pad">
                      <input type="text" id="instansi" name="instansi" placeholder="Pilih Instansi" class="form-control" value="<?= $a ?>" >
                    ...
                    <div class="box-body pad">
                      ...
                      <select class="form-control" id="role" name="role">
                        <?php if ($this->role == 1) { ?>
                          ...
                          <?php
                            $jk=$users->role;
                            if ($jk== "1") echo "<option value='1' selected>Super Admin</option>";
                            else echo "<option value='1'>Super Admin</option>";
                            if ($jk== "2") echo "<option value='2' selected>Admin</option>";
                            else echo "<option value='2'>Admin</option>";
                            if ($jk== "3") echo "<option value='3' selected>Operator</option>";
                            else echo "<option value='3'>Operator</option>";                 
                          ?>
                  ...
                  <div class="box-body pad">
                    <label for=" exampleInputEmail1"><b>Ganti Password</b></label>
                ...
                <div class="box-footer">
                  <a href="<?= base_url('users') ?>" class="btn btn-default pull-left">Kembali</a>
