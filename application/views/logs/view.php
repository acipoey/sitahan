                        ...
                        success: function(data) {
                            ...
                            for (i = 0; i < data.length; i++) {
                                html += '<tr>' +
                                    ...
                                    '<td style="word-wrap: break-word;">' + data[i].tahanan + '</td>' +
                                    '<td style="word-wrap: break-word;">' + new Date(data[i].start_date_old).toDateString("dd-MM-yyyy") + ' - ' + new Date(data[i].end_date_old).toDateString("dd-MM-yyyy") + '</td>' +
                                    '<td style="word-wrap: break-word;">' + new Date(data[i].start_date_new).toDateString("dd-MM-yyyy") + ' - ' + new Date(data[i].end_date_new).toDateString("dd-MM-yyyy") + '</td>' +
                                    '</tr>';
                            }
                            $('#show_data').html(html);
                        }
